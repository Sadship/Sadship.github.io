    ...
    *  You can manage the page options */
    $.sp.options = {
        pages: {
            ...
            "#blog": { title: "Articles", in: "animated fadeInDown", out: "animated fadeOutDown" },
    ...
    *  You can manage the helpers */
    $.sp.helpers = {
        setDocumentTitle: function (hash) {
            document.title = $.sp.options.pages[hash].title + ' |Sadship';
        },
        ...
        home: function (firstTime) {
            if (firstTime) {
                var typed = new Typed('.pages #home .subtitle .typed', {
                    strings: ["FRONTEND DEVELOPER", "UX/UI DESIGNER", "WEB DEVELOPER", "GAMEPLAYER"],
                    typeSpeed: 50,
                    backDelay: 5000,
                    loop: true
                });
